...
<!-- Button trigger modal -->
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=ADMIN_URL?>/?ctrl=home">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-laugh-wink"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Sức Khỏe</div>
            </a>
            ...
            <!-- <div class="sidebar-card">
                <img class="sidebar-card-illustration mb-2" src="template/template/img/undraw_rocket.svg" alt="">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                        <h1 class="h3 text-gray-800 mr-r-1pt">Trang chủ</h1>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Bạn muốn đang xuất?</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Hủy</button>
                    <a class="btn btn-primary" href="<?=ADMIN_URL?>/?ctrl=home&act=logout">Đăng xuất</a>
                </div>
            </div>
        </div>
    </div>
