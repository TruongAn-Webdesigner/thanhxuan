<form method="POST" class="col-10 mx-auto border border-warning p-2 shadow rounded mt-4" action="<?=ADMIN_URL?>/?ctrl=thucpham&act=update">
    ...
    <div class="form-group">
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="anhien" <?php if ($list['anhien'] == 1) {
    echo "checked";
}
?> id="anhien1" value="1">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" name="anhien" <?php if ($list['anhien'] == 0) {
    echo "checked";
}
?> id="anhien0" value="0">
    ...
    <a href="?ctrl=home"><button type="button" class="btn btn-primary">Home</button></a>
</form>
